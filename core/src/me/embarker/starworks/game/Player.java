...
public class Player {
	...
	public static float FIREWORK_SPAWN_INCREASE_RATE = 0.03F; // Amount increased for firework spawn rates every second.
	public static float FIREWORK_SPEED_INCREASE_RATE = 0.03F; // Speed increased for fireworks every second.
